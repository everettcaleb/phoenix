...
TestRenderer2D::TestRenderer2D(const ComponentManager *components)
{
...
void TestRenderer2D::HandleEvent(EVID eventId, void *data)
{
    switch(eventId)
    {
        case EVID_TICK:
...
void TestRenderer2D::OnTick(float deltaTime)
{
